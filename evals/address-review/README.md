# address-review evals

Two scenarios, each a small git repo plus `review-fetch.json` standing in for the GitHub
fetch. Prompts, scripted replies, and assertions are in [`evals.json`](evals.json).

```sh
./setup.sh   # builds throwaway repos in /tmp/address-review-evals
```
